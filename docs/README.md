...
O `README.md` da raiz diz como instalar e usar. Esta pasta diz como o projeto é por dentro, por
que ele é assim, e como trocar uma peça sem reescrever o resto.
